...
//		String to=email;
	...
	public String makePayment(int requestid,int amount, String email) {
...
//		String to=email;
		...
		try {
			...
			// Set Subject: Header field
			message.setSubject("Procedure to make payment");
			
			//Now set the actual message
			String URL= "Please click on this link to make payment for your event space <a href=\"http://localhost:8080/Event-Management-Portal/checkout/"+amount+"/"+requestid+"\">Welcome</a>";
