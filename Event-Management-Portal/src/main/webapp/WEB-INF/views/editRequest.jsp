...
<h2 class="submit-event-tag">
    ...
    <form action="/Event-Management-Portal/updateRequest/${request.id}" method="post">
        <div class="event eventName">
            <label for="EventName">Enter Name of Event</label>
            <input type="text" name="eventName" value="${request.eventName}">
        </div>
         <div class="eventStatus">
            <label for="EventName">Request <br>Status</label>
        ...
        <div class="event description">
            ...
            <select name="province" id="" value="${request.province}">
        ...
        <div class="address-city">
            ...
            <div class="postalcode">
                ...
                <input type="text" name="postalCode" class="postal" value="${request.postalCode }">
            </div>
        </div>
        <div class="event eventDescription">
            <label for="EventName">Event Description</label>
            <input type="text" name="eventDescription" value="${request.eventDescription }">
            <div class=" eventlocation">
                <label for="EventName">Event Location</label>
                <select name="location" id="" value="${request.location }">
        ...
        <div class="event ">
            ...
            <input type="text" name="phoneNumber" value="${request.phoneNumber }">
            </div>
            <div class="email">
        ...
        <div class="event date">
            ...
            <input type="datetime-local" name="eventStartDate" value="${request.eventStartDate }">
            </div>
            <div class="end-date">
                <label for="EventName">End Date and Time</label>
                <input type="datetime-local" name="eventEndDate" value="${request.eventStartDate }"> 
            </div>
        </div>
